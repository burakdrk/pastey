...
for container_instance in list_container_instances_response.data.items:
    if container_instance.lifecycle_state != "DELETED" and container_instance.display_name == DISPLAY_NAME:
        ...
        print("Requested deletion of container instance: " + container_instance.id)
...
while True:
    for container_instance_id in deleted:
        ...
        if container_instance.lifecycle_state == "DELETED":
            print("Container instance deleted: " + container_instance_id)
...
print(create_container_instance_details)
...
#print("Requested creation of container instance: " + create_container_instance_response.data.id)